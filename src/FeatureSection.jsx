      ...
      <div className="grid grid-cols-2 gap-4 md:flex md:flex-wrap md:justify-around w-full px-4 relative">
        ...
        {[
          ...
          <motion.div
            ...
            className="absolute md:relative bg flex flex-col border border-[#e9e9f7] bg-white p-3 md:p-4 rounded-xl items-center justify-center w-40 h-48 md:w-56 md:h-64 shadow-md text-center"
          >
            <img
